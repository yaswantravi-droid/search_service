...
from common.mongodb.connection import DatabaseManager
from search_service.utils.atlas_index_manager import initialize_atlas_indexes

# Initialize database manager for search service - no document models needed since we use raw collections
mongo_db = DatabaseManager(document_models=[])
...
async def connect_db():
    ...
    logger.info("Database connection established - Atlas Search indexes created/updated successfully.")
